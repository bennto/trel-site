    ...
    return (
        <Layout>
            ...
            <section className={styles.hero}>
                <div>
                    <h1>Recruiting Closed</h1>
                    <h2>but feel free to check out some of our positions!</h2>
                </div>
            </section>
...
>>>>>>> 472fe47faaf0b9c47f23ad5dcad3e84b1e5b31ca
                    ...
                    <div className={styles.card}>
                        ...
                        <p className={styles.desc}>Applications are currently closed</p>
                        <div className={styles.choices}>
