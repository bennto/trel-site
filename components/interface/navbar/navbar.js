    ...
    return (
        <>
            ...
            <motion.div className={styles.placeholder}
                        animate={yRef.current > 10 ? "visible" : "hidden"}
                        variants={variants} 
